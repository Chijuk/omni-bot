...
import static ua.omniway.bot.telegram.handlers.OpenObjectCallbackEnums.OPEN_PROCESS_DATA;
import static ua.omniway.bot.telegram.keyboards.ServiceCallKeyboards.menuOnOpen;

@Slf4j
@Component
public class OpenProcessData implements CommandHandler {
    private final ServiceCallsApiService serviceCallsApi;
    private final ProcessDataFormatter formatter;

    @Autowired
    public OpenProcessData(ServiceCallsApiService serviceCallsApi,
    ...
    public String getCommand() {
        return OPEN_PROCESS_DATA.getHandler();
    }
    ...
    public void onCommandMessage(AbstractTelegramBot bot, Update update, Message message, String[] args, DefaultDbContext context) throws Exception {
        ...
        try {
            ...
            ProcessData processDataObject = serviceCallsApi.getProcessDataObject(otUniqueId);
            ...
            if (processDataObject != null) {
                ...
                sendMessage = SendMessage.builder()
                        ...
                        .text(formatter.summary(processDataObject, dbUser))
